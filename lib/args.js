...
function getRuntimeEnvironment() {
  try {
    ...
    if (e instanceof ReferenceError) return 'Node';
  }
}
...
if (options.clientKey) {
  try {
    ...
    const watcherClientKeyPassphrase = pe.WATCHER_CLIENT_SECRET;
    options.clientKey = getPrivateKey ( options.clientKey,watcherClientKeyPassphrase, options.prompt)
  }
  catch (e) {
  ...
  options.clientSecret = pe.WATCHER_CLIENT_SECRET
